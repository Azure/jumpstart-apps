...
const NumberOfProductsManufacturedGraph = () => {
    ...
    <CardHeader
      header={<Text className={classes.ContainerBoxHeading}>Number of products manufactured</Text>}
      description={
...
<>
  ...
  export default NumberOfProductsManufacturedGraph;