...
const useStyles = makeStyles({
  ...
  const stackTokens: IStackTokens = {
    childrenGap: 10,
    padding: '0 0', // This creates equal padding on left and right
  };

const SuiteFooter: React.FC = () => {
    ...
    <Stack horizontal styles={containerStyles} tokens={stackTokens}>
        <Stack id='footerbottom' styles={footerBottom}>
            ...
            <Stack.Item grow styles={itemStyles} id='arcjumpstart'>
                <img src='Jumpstart Banner v2 White 2.svg' alt='Jumpstart Banner ' className={classes.footerArcJumpstart}/>
            </Stack.Item>            
      </Stack>
    </Stack>
    );
